...
test('put', function (t) {
  ...
  stackpath.put('account.json', 'name=' + time1, function (err, res) {
  ...
  stackpath.put('account.json/address', '{ "street1": "' + time2 + '" }', function (err, res) {
  ...
  stackpath.put('account.json/address', { street2: time3 }, function (err, res) {
